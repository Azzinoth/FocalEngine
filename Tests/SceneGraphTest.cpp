...
TEST_F(SceneGraphTest, Check_MoveNode_Function)
{
	...
	// To make it easier to debug, we will use a fixed seed for the random number generator.
	srand(42);
...
TEST_F(SceneGraphTest, Check_Extensive_Node_Manipulation)
{
	...
	for (size_t i = 0; i < 10000; i++)
	{
		...
		if (RandomAction == 0)
		{
			...
			{
				FEEntity* Entity = SCENE.AddEmptyEntity("Node_" + std::to_string(SCENE.SceneGraph.GetNodeCount()));
				Nodes.push_back(SCENE.SceneGraph.GetNodeByOldEntityID(Entity->GetObjectID()));
			}
...
TEST_F(SceneGraphTest, Check_Position_Inheritance_Propagation)
{
	...
	FEEntity* Entity_0 = reinterpret_cast<FEEntity*>(Nodes[0]->GetOldStyleEntity());
	FEEntity* Entity_1 = reinterpret_cast<FEEntity*>(Nodes[1]->GetOldStyleEntity());

	// Update only the parent node's transformation.
	Entity_0->Transform.SetPosition(glm::vec3(14.0f, 18.0f, -5.0f));
	...
	glm::mat4 ChildTransformMatrix = Entity_1->Transform.GetTransformMatrix();
...
TEST_F(SceneGraphTest, Check_Rotation_Inheritance_Propagation)
{
	...
	Entity_0->Transform.SetQuaternion(Rotation);
...
TEST_F(SceneGraphTest, Check_Scale_Inheritance_Propagation)
{
	...
	Entity_0->Transform.SetScale(glm::vec3(2.0f, 2.0f, 2.0f));
...
TEST_F(SceneGraphTest, Check_Multi_Level_Inheritance_Propagation_Tiny)
{
	...
	FEEntity* Entity_0 = reinterpret_cast<FEEntity*>(Nodes[0]->GetOldStyleEntity());
	FEEntity* Entity_1 = reinterpret_cast<FEEntity*>(Nodes[1]->GetOldStyleEntity());
	FEEntity* Entity_2 = reinterpret_cast<FEEntity*>(Nodes[2]->GetOldStyleEntity());
	FEEntity* Entity_3 = reinterpret_cast<FEEntity*>(Nodes[3]->GetOldStyleEntity());

	// Apply transformations to various nodes
	Entity_0->Transform.SetPosition(glm::vec3(10.0f, 10.0f, 10.0f));
	Entity_1->Transform.SetQuaternion(glm::angleAxis(glm::radians(30.0f), glm::vec3(0, 1, 0)));
	Entity_2->Transform.SetScale(glm::vec3(1.5f, 1.5f, 1.5f));
	...
	glm::mat4 ActualMatrix = Entity_3->Transform.GetTransformMatrix();
...
TEST_F(SceneGraphTest, Check_Multi_Level_Inheritance_Propagation_Small)
{
	...
	FEEntity* Entity_1 = reinterpret_cast<FEEntity*>(Nodes[1]->GetOldStyleEntity());
	FEEntity* Entity_2 = reinterpret_cast<FEEntity*>(Nodes[2]->GetOldStyleEntity());
	FEEntity* Entity_6 = reinterpret_cast<FEEntity*>(Nodes[6]->GetOldStyleEntity());
	FEEntity* Entity_13 = reinterpret_cast<FEEntity*>(Nodes[13]->GetOldStyleEntity());

	// Apply transformations to various nodes
	Entity_0->Transform.SetPosition(glm::vec3(10.0f, 10.0f, 10.0f));
	Entity_1->Transform.SetQuaternion(glm::angleAxis(glm::radians(45.0f), glm::vec3(0, 1, 0)));
	Entity_2->Transform.SetScale(glm::vec3(2.0f, 2.0f, 2.0f));
	Entity_6->Transform.SetPosition(glm::vec3(5.0f, 0.0f, 0.0f));
	...
	glm::mat4 ActualMatrix = Entity_13->Transform.GetTransformMatrix();
	ASSERT_TRUE(GEOMETRY.IsEpsilonEqual(ExpectedMatrix, ActualMatrix));
...
TEST_F(SceneGraphTest, Check_Multi_Level_Inheritance_Propagation_Medium)
{
	...
	FEEntity* Entity_1 = reinterpret_cast<FEEntity*>(Nodes[1]->GetOldStyleEntity());
	FEEntity* Entity_2 = reinterpret_cast<FEEntity*>(Nodes[2]->GetOldStyleEntity());
	FEEntity* Entity_7 = reinterpret_cast<FEEntity*>(Nodes[7]->GetOldStyleEntity());
	FEEntity* Entity_16 = reinterpret_cast<FEEntity*>(Nodes[16]->GetOldStyleEntity());
	FEEntity* Entity_25 = reinterpret_cast<FEEntity*>(Nodes[25]->GetOldStyleEntity());

	// Apply transformations to various nodes
	Entity_0->Transform.SetPosition(glm::vec3(10.2f, -10.0f, 0.124f));
	Entity_1->Transform.SetQuaternion(glm::angleAxis(glm::radians(47.8f), glm::vec3(0, 1, 0)));
	Entity_2->Transform.SetScale(glm::vec3(2.2f, 2.2f, 2.2f));
	Entity_7->Transform.SetPosition(glm::vec3(5.0f, 0.5f, -4.3f));
	Entity_16->Transform.SetQuaternion(glm::angleAxis(glm::radians(67.0f), glm::vec3(1, 0, 0)));
	...
	glm::mat4 ActualMatrix = Entity_25->Transform.GetTransformMatrix();
	ASSERT_TRUE(GEOMETRY.IsEpsilonEqual(ExpectedMatrix, ActualMatrix));
...
std::vector<FENaiveSceneGraphNode*> SceneGraphTest::PopulateSceneGraph(size_t NodeCount)
{
	...
	{
		FEEntity* Entity = SCENE.AddEmptyEntity("Node_" + std::to_string(i));
		Nodes.push_back(SCENE.SceneGraph.GetNodeByOldEntityID(Entity->GetObjectID()));
	}
